...
def _search_enterprise_knowledge(query: str, limit: int = 8, query_vector: list[float] | None = None):
...
def search_enterprise_knowledge(query: str, limit: int = 8, query_vector: list[float] | None = None):
    """
    ...
    """
    try:
        return _search_enterprise_knowledge(query, limit=limit, query_vector=query_vector)
